...
const FloatingChat = () => {
  const WHATSAPP_URL = "https://api.whatsapp.com/send?phone=5519996031818"; // Troque pelo número desejado

  return (
    <button
      onClick={() => window.open(WHATSAPP_URL, "_blank")}
      className="fixed bottom-8 right-8 sm:bottom-6 sm:right-6 flex w-16 h-16 justify-center items-center rounded-full bg-[#25D366] shadow-[0_4px_16px_rgba(0,0,0,0.16)] z-50 hover:scale-105 transition-all"
